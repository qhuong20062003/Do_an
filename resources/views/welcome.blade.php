                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        @php
                            ...
                            $parentCategories = $categories->filter(fn($cat) => is_null($cat->parent_id) || $cat->parent_id == 0);
                        @endphp

                        @foreach ($parentCategories as $parent)
                            @php
                                // Lấy category con của category cha này
                                $children = $categories->filter(fn($cat) => $cat->parent_id == $parent->id);
                            @endphp
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                        @foreach ($children as $child)
                                            <a class="dropdown-item" href="{{ route('categories.showHome', ['id' => $child->id]) }}" class="dropdown-item">
                                                {{ $child->name }}
                                            </a>
                                        @endforeach
                                    </div>
                            ...
                            @else
                                <a href="{{ route('categories.showHome', ['id' => $parent->id]) }}" class="nav-item nav-link">
                                    {{ $parent->name }}
                                </a>
                            @endif
                        @endforeach
